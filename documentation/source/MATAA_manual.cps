...
\entry {Delay, interchannel (soundcard)}{9}
\entry {Documentaion, MATAA}{3}
...
\entry {Interchannel delay}{9}
\initial {M}
\entry {Manual, MATAA}{3}
\entry {MATAA default paths}{3}
\entry {MATAA documentation}{3}
\entry {MATAA scripts}{3}
...
\entry {Soundcard interchannel delay}{9}
...
\entry {TestDevices}{4, 7}
\entry {TestTone}{4, 7}
\entry {Tools}{3}
\initial {V}
\entry {Vector}{57}
\entry {Vector (row, column)}{57}
