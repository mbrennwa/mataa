...
\entry {DUT channel}{7}
\initial {F}
\entry {FDL, GNU Free Documentation License}{61}
\entry {Filter, anti-aliasing}{6}
\initial {G}
\entry {GNU General Public License}{57}
\entry {GPL, GNU General Public License}{57}
\initial {H}
